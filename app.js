...
// The 'this' in this case represents the instance 'joe' passed into the Student constructor function.

// 2. What is "this" when joe.scopeArrow() is invoked?
// The 'this' in this case represents the global scope window object.

// 3. Explain why "this" is different when an arrow function is used.
//  In an arrow function, 'this' refers to the enclosing functional scope. If there isn't a non-arrow functional scope, "this" will refer to the global window object.